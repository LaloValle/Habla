...
const phonemes = {
    ...
    tʃ:{
        ...
        associated: ['ch'],
        examples: [
            // 2 positions for the highlight are added for the web takes the symbol 'tʃ' as 2 characters
            { word: 'chico', phonemes: 'tʃíko', highlight:[0,1] },
            { word: 'chamizal', phonemes: 'tʃamisál', highlight:[0,1] },
            { word: 'cacharro', phonemes: 'katʃaro', highlight: [2,3] }
        ]
    },
    f:{
        phoneme: 'f',
